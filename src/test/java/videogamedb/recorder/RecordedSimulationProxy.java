  ...
  private ScenarioBuilder scn = scenario("RecordedSimulationProxy")
    ...
    .exec(
      http("request_2")
        ...
        .headers(headers_2)
        .body(RawFileBody("recorder/recordedsimulationproxy/0002_request.json"))
    )
    .pause(11)
    .exec(
      http("request_3")
        .post("/api/videogame")
        .headers(headers_3)
        .body(RawFileBody("recorder/recordedsimulationproxy/0003_request.json"))
    )
    .pause(6)
    .exec(
      http("request_4")
        .put("/api/videogame/3")
        .headers(headers_4)
        .body(RawFileBody("recorder/recordedsimulationproxy/0004_request.json"))
    )
    .pause(4)
    .exec(
      http("request_5")
